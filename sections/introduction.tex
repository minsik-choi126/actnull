...
LoRA the answer is mostly the rank constraint. Since $\mathrm{row}(BA)\subseteq\mathrm{row}(A)$, a
shared $A$ confines both updates to one $16$-dimensional row space, where two independent top-$8$
subspaces already agree at $k/r$. An $A$- and factor-spectrum-conditioned null reproduces $80.3\%$
of the product update's above-isotropic overlap, against $82.0\%$ from that one-line count. Its
attainable plant delivers $37.4$--$57.0\%$ of the nominal increment and the null recovers
$100.7$--$101.1\%$ of what is delivered, so the construction is calibrated; it simply has little
left to explain.
